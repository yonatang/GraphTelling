...
d3.tsv("data/norm/migr_asydcfsta2-small.tsv", function (error, data) {
    ...
    var VALID_YEARS = {'2008': true, '2009': true, '2010': true, '2011': true, '2012': true, '2013':true,'2014':true,'2015':true};
    ...
    theData.forEach(function (d) {
        ...
        years.forEach(function(year){ d[year] *= 1; });
    });

    var sumRollupFunction = function (props) {
